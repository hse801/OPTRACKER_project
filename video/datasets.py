...
class LoadStreams:  # multiple IP or RTSP cameras
    def __init__(self, sources='streams.txt', img_size=640, auto=True):
        ...
        s = np.stack([letterbox(x, self.img_size,auto=self.auto)[0].shape for x in self.imgs])
    ...
    def __next__(self):
        ...
        # Letterbox
        img0 = self.imgs.copy()
        img = [letterbox(x, self.img_size,auto=self.rect and self.auto)[0] for x in img0]
